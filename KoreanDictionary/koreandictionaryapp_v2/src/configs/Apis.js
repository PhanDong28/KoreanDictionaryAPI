...
export let endpoint = {
    ...
    "hanViet": (originalWord) => `/original-word/han-viet/?original-word=${originalWord}`,
    "wordType": (originalWord) => `original-word/word-type/?original-word=${originalWord}`,
    "pronounce": (originalWord) => `original-word/pronounce/?original-word=${originalWord}`
}
